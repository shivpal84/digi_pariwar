...
class _$LessonModelImpl implements _LessonModel {
  ...
  @override
  String toString() {
    return 'LessonModel(id: $id, title: $title, description: $description, order: $order, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _LessonModel implements LessonModel {
  const factory _LessonModel(
      ...
      required final DateTime updatedAt}) = _$LessonModelImpl;
